...
export const zhCn: Dict = {
  ...
  webimRetrySend: '重新发送',
  webimRouterUnavailable: 'Router 当前不可用，请查看系统状态。',
  ...
  sysInfoReload: '刷新状态',
  sysInfoRestart: '重启设备',
  safeModeClear: '清除安全模式',
  safeModeCleared: '安全模式已清除，设备将重启。',
  runtimeSafeMode: '安全模式',
  runtimeResetReason: '上次重启原因',
  runtimeRouterState: 'Router 状态',
  runtimeRouterReason: 'Router 原因',
  runtimeRouterQueues: '事件/动作队列',
  runtimeRouterStack: 'Router/Action 栈水位',
  runtimeRouterFailures: '失败/丢弃',

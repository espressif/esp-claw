export const en = {
  ...
  webimRouterUnavailable: 'Router is unavailable. Check System Status.',
  ...
  safeModeClear: 'Clear Safe Mode',
  safeModeCleared: 'Safe mode cleared. Device restart scheduled.',
  runtimeSafeMode: 'Safe Mode',
  runtimeResetReason: 'Reset Reason',
  runtimeRouterState: 'Router State',
  runtimeRouterReason: 'Router Reason',
  runtimeRouterQueues: 'Event/Action Queue',
  runtimeRouterStack: 'Router/Action Stack HWM',
  runtimeRouterFailures: 'Failed/Dropped',

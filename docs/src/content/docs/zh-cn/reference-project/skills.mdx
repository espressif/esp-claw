...
你可以在 [Skill package spec](https://github.com/espressif/esp-claw/blob/master/components/common/skill_builder/skills/skill_creator/references/skill-package-spec.md) 中找到 ESP-Claw 的 Skill 规范。该文件也会随内置 `skill_creator` 一起打包，供设备 Agent 使用。
...
其他字段请参考 [Skill package spec](https://github.com/espressif/esp-claw/blob/master/components/common/skill_builder/skills/skill_creator/references/skill-package-spec.md)。

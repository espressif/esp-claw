...
源码：<LinkToSource relativePath="framework/capabilities/files/src/cap_files.c" /> · 头文件：<LinkToSource relativePath="framework/capabilities/files/include/cap_files.h" />

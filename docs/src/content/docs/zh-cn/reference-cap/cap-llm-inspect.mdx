...
源码：<LinkToSource relativePath="framework/capabilities/llm_inspect/src/cap_llm_inspect.c" /> · 头文件：<LinkToSource relativePath="framework/capabilities/llm_inspect/include/cap_llm_inspect.h" />

...
Header: <LinkToSource relativePath="framework/foundation/claw_cap/include/claw_cap.h" />
...
see the visible-group configuration in <LinkToSource relativePath="applications/shared/app_claw/app_capabilities.c" />.

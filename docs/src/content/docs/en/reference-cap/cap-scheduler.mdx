...
Source: <LinkToSource relativePath="framework/capabilities/scheduler/src/cap_scheduler.c" /> · Header: <LinkToSource relativePath="framework/capabilities/scheduler/include/cap_scheduler.h" />

...
Understand two structs from <LinkToSource relativePath="framework/foundation/claw_cap/include/claw_cap.h" /> before coding:
...
<FileTree>
- framework/capabilities/my_feature
    - CMakeLists.txt
    - include
...
At build time, `framework/build_support/skill_builder` syncs these files under the FATFS skills root (default `/fatfs/skills/`).

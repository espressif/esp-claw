...
Source: <LinkToSource relativePath="framework/capabilities/cap_llm_inspect/src/cap_llm_inspect.c" /> · header: <LinkToSource relativePath="framework/capabilities/cap_llm_inspect/include/cap_llm_inspect.h" />

...
Source: <LinkToSource relativePath="framework/capabilities/web_search/src/cap_web_search.c" /> ·
header: <LinkToSource relativePath="framework/capabilities/web_search/include/cap_web_search.h" /> ·
Skill: <LinkToSource relativePath="framework/capabilities/web_search/skills/cap_web_search/SKILL.md" />

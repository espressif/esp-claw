...
Source: <LinkToSource relativePath="framework/capabilities/system/src/cap_system.c" /> · Header: <LinkToSource relativePath="framework/capabilities/system/include/cap_system.h" />

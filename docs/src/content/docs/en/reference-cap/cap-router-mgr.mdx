...
Source: <LinkToSource relativePath="framework/capabilities/cap_router_mgr/src/cap_router_mgr.c" /> ·
header: <LinkToSource relativePath="framework/capabilities/cap_router_mgr/include/cap_router_mgr.h" /> ·
Skill: <LinkToSource relativePath="framework/capabilities/cap_router_mgr/skills/cap_router_mgr/SKILL.md" />

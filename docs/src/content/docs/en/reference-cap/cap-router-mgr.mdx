...
Source: <LinkToSource relativePath="framework/capabilities/router_manager/src/cap_router_mgr.c" /> ·
header: <LinkToSource relativePath="framework/capabilities/router_manager/include/cap_router_mgr.h" /> ·
Skill: <LinkToSource relativePath="framework/capabilities/router_manager/skills/cap_router_mgr/SKILL.md" />

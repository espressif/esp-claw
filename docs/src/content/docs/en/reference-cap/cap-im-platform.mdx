...
Entry point: <LinkToSource relativePath="framework/capabilities/cap_im_platform/src/cap_im_platform.c" /> ·
header: <LinkToSource relativePath="framework/capabilities/cap_im_platform/include/cap_im_platform.h" /> ·
Skill: <LinkToSource relativePath="framework/capabilities/cap_im_platform/skills/cap_im_platform/SKILL.md" />
...
|--------|----------------|
| <LinkToSource relativePath="framework/capabilities/cap_im_platform/src/cap_im_platform.c" /> | Registers all enabled IM runtime groups. |
| <LinkToSource relativePath="framework/capabilities/cap_im_platform/src/cap_im_feishu.c" /> | Feishu WebSocket/Event API ingress, rich text flattening, and sends. |
| <LinkToSource relativePath="framework/capabilities/cap_im_platform/src/cap_im_qq.c" /> | QQ Bot WebSocket ingress, token handling, and sends. |
| <LinkToSource relativePath="framework/capabilities/cap_im_platform/src/cap_im_tg.c" /> | Telegram long-poll ingress, attachment download queue, and sends. |
| <LinkToSource relativePath="framework/capabilities/cap_im_platform/src/cap_im_wechat.c" /> | WeChat ClawBot polling, QR login state, and sends. |
| <LinkToSource relativePath="framework/capabilities/cap_im_platform/src/cap_im_attachment.c" /> | Shared local attachment path helpers. |

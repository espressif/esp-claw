...
Source: <LinkToSource relativePath="framework/capabilities/cap_http_request/src/cap_http_request.c" /> ·
header: <LinkToSource relativePath="framework/capabilities/cap_http_request/include/cap_http_request.h" /> ·
Skill: <LinkToSource relativePath="framework/capabilities/cap_http_request/skills/cap_http_request/SKILL.md" />

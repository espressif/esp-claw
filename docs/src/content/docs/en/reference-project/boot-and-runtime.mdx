...
This walkthrough uses sample app `applications/edge_agent`, covering entry <LinkToSource relativePath="applications/edge_agent/main/main.c" /> and wiring in <LinkToSource relativePath="applications/shared/app_claw/app_claw.c" />.

## `main.c` entry

<LinkToSource relativePath="applications/edge_agent/main/main.c" /> initializes required system pieces and peripherals so the ESP-Claw Agent can run.
...
<LinkToSource relativePath="applications/shared/app_claw/app_claw.c" /> initializes the Agent stack in order, then launches the Console REPL.

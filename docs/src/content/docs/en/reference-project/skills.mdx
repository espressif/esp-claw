...
You can find the ESP-Claw Skill specification in the [Skill package spec](https://github.com/espressif/esp-claw/blob/master/components/common/skill_builder/skills/skill_creator/references/skill-package-spec.md). The same file is bundled with the built-in `skill_creator` for the device Agent.
...
For other fields, see the [Skill package spec](https://github.com/espressif/esp-claw/blob/master/components/common/skill_builder/skills/skill_creator/references/skill-package-spec.md).

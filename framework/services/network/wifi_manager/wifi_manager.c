...
#ifndef CONFIG_WIFI_MANAGER_AP_SSID_PREFIX
#define CONFIG_WIFI_MANAGER_AP_SSID_PREFIX "esp-claw"
#endif
#ifndef CONFIG_WIFI_MANAGER_AP_CHANNEL
#define CONFIG_WIFI_MANAGER_AP_CHANNEL 1
#endif
#ifndef CONFIG_WIFI_MANAGER_AP_MAX_CONN
#define CONFIG_WIFI_MANAGER_AP_MAX_CONN 4
#endif
#ifndef CONFIG_WIFI_MANAGER_MAX_RETRY
#define CONFIG_WIFI_MANAGER_MAX_RETRY 5
#endif
...
static const char *wifi_manager_ap_ssid_prefix(void)
{
    return (s_config.ap_ssid_prefix && s_config.ap_ssid_prefix[0] != '\0')
           ...
           : CONFIG_WIFI_MANAGER_AP_SSID_PREFIX;
}

static uint8_t wifi_manager_ap_channel(void)
{
    return s_config.ap_channel ? s_config.ap_channel : CONFIG_WIFI_MANAGER_AP_CHANNEL;
}

static uint8_t wifi_manager_ap_max_conn(void)
{
    return s_config.ap_max_conn ? s_config.ap_max_conn : CONFIG_WIFI_MANAGER_AP_MAX_CONN;
}

static uint32_t wifi_manager_max_retry(void)
{
    return s_config.max_retry ? s_config.max_retry : CONFIG_WIFI_MANAGER_MAX_RETRY;
}

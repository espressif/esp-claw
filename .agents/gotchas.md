...
`framework/lua_modules/driver_xxx/README.md` files are agent-facing documentation. They explain how an agent should use the Lua driver and are meant to be read as operating instructions, not as user marketing docs or full developer manuals.
